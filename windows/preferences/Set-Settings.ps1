...
Function EnableLockScreenSpotlight {
    Write-Host "Enabling Lock screen spotlight..."
...
Function RemoveDefaultPrinters {
    Write-Output "Attempting to remove default printers..."
...
Function ResetWindowsUpdateSettings {
    Write-Output 'Attempting to reset Windows update settings...'
